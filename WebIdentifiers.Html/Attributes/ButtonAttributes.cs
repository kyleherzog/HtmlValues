...
public class ButtonAttributes : GlobalAttributes
{
    ...
    /// <param name="value">An optional value to apply to the attribute.</param>
    /// <returns>The new <see cref="HtmlAttribute"/> instance.</returns>
    public HtmlAttribute FormAction(string? value = null) => HtmlAttributes.FormAction(value);
    ...
    /// <param name="value">An optional value to apply to the attribute.</param>
    /// <returns>The new <see cref="HtmlAttribute"/> instance.</returns>
    public HtmlAttribute FormEncType(string? value = null) => HtmlAttributes.FormEncType(value);
    ...
    /// <param name="value">An optional value to apply to the attribute.</param>
    /// <returns>The new <see cref="HtmlAttribute"/> instance.</returns>
    public HtmlAttribute FormMethod(string? value = null) => HtmlAttributes.FormMethod(value);
    ...
    /// <param name="value">An optional value to apply to the attribute.</param>
    /// <returns>The new <see cref="HtmlAttribute"/> instance.</returns>
    public HtmlAttribute FormNoValidate(string? value = null) => HtmlAttributes.FormNoValidate(value);
    ...
    /// <param name="value">An optional value to apply to the attribute.</param>
    /// <returns>The new <see cref="HtmlAttribute"/> instance.</returns>
    public HtmlAttribute FormTarget(string? value = null) => HtmlAttributes.FormTarget(value);
